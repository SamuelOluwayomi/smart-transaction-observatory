...
*Note for Bounty Submission: This document should be copied to a public Notion or Google Doc and linked in the README to satisfy the external architecture document requirement.*
